...
public class PluginLoader extends ClassLoader {
    ...
    public String findLibrary(String lib) {
        ...
        try {
            ...
            main.java.com.valhalla.Logger.debug(temporaryDll.getPath());
    ...
    public void loadPlugins() {
        for (int i = 0; i < availablePlugins.size(); i++) {
            ...
            if (!jar.getLoaded()) {
                ...
                main.java.com.valhalla.Logger.debug("Plugin is already loaded.");
            }
        }
    }
            ...
            if (files[i].endsWith(".jar")) {
                try {
                    ...
                    if (props == null || props.getProperty("mainClass") == null
                        ...
                        main.java.com.valhalla.Logger.debug("Incompatible plugin found: " +
                                                  name + " (" + files[i] + ")");
                    } else {
                    ...
                    main.java.com.valhalla.Logger.debug("Invalid plugin found: "
                            + files[i]);
                }
            }
        }
    ...
    public InputStream getResourceAsStream(String resource) {
        ...
        if (jar != null) {
            ...
            main.java.com.valhalla.Logger.debug("Stream was null for " + resource);
        }
