        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (props.getProperty("selected") != null) {
                ...
                if (newFile.exists() && !newFile.delete()) {
                    main.java.com.valhalla.Logger.debug("Could not delete old plugin!");
                }

                if (!file.renameTo(newFile)) {
                    main.java.com.valhalla.Logger.debug("Could not rename to new plugin");
                }
            }
        }
                    ...
                    // all lines after are plugin information lines
                        ...
                        if (de.length == names.length) {
                            ...
                            if (PluginLoader.checkPlatform (props)
                                ...
                                main.java.com.valhalla.Logger.debug( props.getProperty("APIVersion"));
