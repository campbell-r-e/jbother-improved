...
public class PluginJAR {
    ...
    public Plugin loadPlugin() {
        ...
        if (loaded)
            main.java.com.valhalla.Logger.debug(getName() + " Plugin Loaded");
        else
            main.java.com.valhalla.Logger.debug("Error loading " + getName());
    ...
    public void unloadPlugin() {
        main.java.com.valhalla.Logger.debug("Unloading Plugin " + getName());
        plugin.unload();
        this.loaded = false;
    }
