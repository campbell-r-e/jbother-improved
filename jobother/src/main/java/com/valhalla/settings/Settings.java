...
package main.java.com.valhalla.settings;
...
public class Settings extends Properties {
    ...
    private Settings(String dir, String settingsFile) {
        ...
        try {
            ...
            main.java.com.valhalla.Logger.debug("Could not load settings file");
            main.java.com.valhalla.Logger.debug(e.getMessage());
        }
        saving = false;
    }
    ...
    public static void writeSettings() {
        ...
        try {
            ...
            main.java.com.valhalla.Logger.debug(e.toString());
        }
        saving = false;
    }
    ...
    public static void createKioskRoom() {
        ...
        try {
            ...
            main.java.com.valhalla.Logger.debug(ioe.getMessage());
            // System.exit(-1);
        }
    }
}