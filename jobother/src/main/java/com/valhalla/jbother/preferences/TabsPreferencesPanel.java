...
import main.java.com.valhalla.gui.MJTextField;
import main.java.com.valhalla.gui.Standard;
import main.java.com.valhalla.jbother.BuddyList;
import main.java.com.valhalla.jbother.ConversationPanel;
...
//        add(dockBox);
    ...
    public void switchToNonICQInterface() {
        main.java.com.valhalla.Logger.debug("Switching to non-ICQ style interface");
    ...
    public void switchToICQInterface() {
        main.java.com.valhalla.Logger.debug("Switching to ICQ style interface...");
        ...
        while (i.hasNext()) {
            ...
            if (BuddyList.getInstance().getTabFrame() != null
                ...
                main.java.com.valhalla.Logger.debug("creating frame for " + panel);
                panel.createFrame();
