...
import main.java.com.valhalla.gui.CopyPasteContextMenu;
import main.java.com.valhalla.jbother.BuddyList;
import main.java.com.valhalla.jbother.ConversationFormatter;
import main.java.com.valhalla.jbother.JBother;
import main.java.com.valhalla.jbother.JBotherLoader;
import main.java.com.valhalla.jbother.jabber.BuddyStatus;
import main.java.com.valhalla.settings.Settings;
import main.java.com.valhalla.settings.TempSettings;
import main.java.org.jfree.ui.FontChooserDialog;
...
public class AppearancePreferencesPanel extends JPanel implements
    ...
    private JComboBox getStatusThemes() {
        ...
        if (stream == null) {
            main.java.com.valhalla.Logger.debug("Bad status theme file.");
            return box;
        }
    ...
    private JComboBox getEmoticonThemes() {
        ...
        if (stream == null) {
            main.java.com.valhalla.Logger.debug("Bad emoticon theme file.");
            return box;
        }
    ...
    public static void updateApplicationFonts(Font font, PreferencesDialog prefs) {
        main.java.com.valhalla.jbother.JBotherLoader.setupFont(font);
        updateAllUIs();
