...
import main.java.com.valhalla.gui.NMOptionDialog;
import main.java.com.valhalla.gui.Standard;
import main.java.com.valhalla.gui.WaitDialog;
    ...
    class AddBuddyThread implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                if (modify) {
                    main.java.com.valhalla.Logger.debug("modifying roster item");
                    ...
                    if (groupName != null && !groupName.equals("")) {
                        ...
                        if (newGroup == null) {
                            main.java.com.valhalla.Logger.debug("had to create new group" + groupName);
                            newGroup = roster.createGroup(groupName);
                        } else {
                            main.java.com.valhalla.Logger.debug("found group " + newGroup.getName());
                        }

                        if (c != 0) {
                            main.java.com.valhalla.Logger.debug("Moving buddy to " + newGroup.getName());
