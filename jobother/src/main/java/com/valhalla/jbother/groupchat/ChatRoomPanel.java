...
package main.java.com.valhalla.jbother.groupchat;
...
import main.java.com.valhalla.jbother.jabber.smack.InvitationRejectionPacketListener;
import main.java.com.valhalla.jbother.plugins.events.MUCEvent;
...
public class ChatRoomPanel extends JPanel implements LogViewerCaller,
    ...
    public void doAction(String command, MUCBuddyStatus buddy) {
        ...
        main.java.com.valhalla.Logger.debug("Running " + command + " on "
                + buddy.getUser());
    ...
    private void leaveChat() {
        ...
        buddyStatuses.clear();
        main.java.com.valhalla.Logger.debug("Leaving " + chat.getRoom());
    ...
    public void receiveMessage(String from, String message,
        ...
        if (from.equals("")
            ...
            if (message.startsWith("/me ")) {
                ...
                main.java.com.valhalla.jbother.sound.SoundPlayer
