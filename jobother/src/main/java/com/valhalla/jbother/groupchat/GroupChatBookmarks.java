...
public class GroupChatBookmarks extends JDialog {
    ...
    class SaveBookmark implements Runnable
    {
        public void run()
        {
            ...
            catch( Exception ex ) { main.java.com.valhalla.Logger.logException(ex);}
        }
    }
    ...
    class CollectBookmarks implements Runnable
    {
        ...
        public void run()
        {
            try {
                ...
                main.java.com.valhalla.Logger.debug("Private Data is not supported, using local storage");
            }
            catch( Exception ex ) { 
    ...
    private void performAutoJoin()
    {
        ...
        for( int i = 0; i < list.length; i ++ )
        {
            ...
            { 
                main.java.com.valhalla.Logger.logException(iox);
            }
        }
    }
