...
import main.java.com.valhalla.gui.*;
import main.java.com.valhalla.jbother.jabber.BuddyStatus;
import main.java.com.valhalla.jbother.jabber.MUCBuddyStatus;
import main.java.com.valhalla.jbother.jabber.smack.SecureExtension;
import main.java.com.valhalla.jbother.menus.ConversationPopupMenu;
import main.java.com.valhalla.jbother.plugins.events.*;
 ...
 *@version    1.1
 *@see        main.java.com.valhalla.jbother.jabber.BuddyStatus
 */
        ...
        SwingUtilities.invokeLater(
            new Runnable() {
                public void run() {
                    ...
                    main.java.com.valhalla.Logger.debug("updating resources " + buddy.getUser());
                    ...
                    while (i.hasNext()) {
                        ...
                        if (!key.equals("N/A")) {
                            ...
                            if (key.equals(selected)) {
                                sel = count;
                                main.java.com.valhalla.Logger.debug("sel" + selected);
                            }
                            count++;
                        }
                    }
...
//                    });
    ...
    public boolean sendBuddyMessage(String text) {
        ...
        for (int i = 0; i < send.size(); i++) {
            ...
            main.java.com.valhalla.pluginmanager.PluginChain.fireEvent(event);
            ...
            try {
                ...
                main.java.com.valhalla.Logger.debug("Could not send message: "
                         + e.getMessage());
            }
        }
