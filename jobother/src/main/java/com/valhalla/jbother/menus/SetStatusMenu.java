...
import main.java.com.valhalla.jbother.jabber.SelfStatus;
import main.java.com.valhalla.jbother.jabber.SelfStatuses;
...
public class SetStatusMenu extends JPopupMenu {
	...
	private SelfStatuses statuses = main.java.com.valhalla.jbother.jabber.SelfStatuses
			.getInstance();
...
//            super.setIcon(StatusIconCache.getStatusIcon(mode));
	...
	private void uncheckAll(JCheckBoxMenuItem item) {
		...
		main.java.com.valhalla.Logger.debug("Unckecking all but " + item);
		for (int i = 0; i < getComponentCount (); i++) {
