    ...
    private class StatusMessageProperties extends Properties
    {
        ...
        public void loadFromFile()
        {
            ...
            if(!propDir.isDirectory())
            {
                ...
                {
                    main.java.com.valhalla.Logger.debug("Could not create directory for StatusMessageProperties file! ("
                         + propDir.getName() + ")");
                }
            ...
            if(propFile.isFile())
            {
                ...
                {
                    main.java.com.valhalla.Logger.debug("Could not load away message properties file");
        ...
        public void saveToFile()
        {
            ...
            if(propDir.isDirectory())
            {
                ...
                {
                    main.java.com.valhalla.Logger.debug("Could not save away message properties file");
                    main.java.com.valhalla.Logger.debug(e.getMessage());
                }
            }
