...
import main.java.com.valhalla.settings.Arguments;
...
public class MessagePacketListener implements PacketListener {
    ...
    private class QueueListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            main.java.com.valhalla.Logger.debug("Emptying message queue - contains "
    ...
    public void processPacket(Packet message) {
        ...
        if (!started) {
            main.java.com.valhalla.Logger.debug("Message received, adding to queue.");
        ...
        if (packet.getType() == Message.Type.NORMAL) {
            ...
            if (BuddyList.getInstance().getBlockedUsers().containsKey(userId)) {
                main.java.com.valhalla.Logger.debug("Blocking user: " + userId);
                return;
            }
