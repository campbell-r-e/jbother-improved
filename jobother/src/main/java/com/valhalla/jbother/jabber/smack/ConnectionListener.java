...
public class ConnectionListener implements
    ...
    public void connectionClosedOnError(Exception e) {
        ...
        main.java.com.valhalla.jbother.ConnectorThread.getInstance().setHasHadError(true);
        String errorMessage = resources.getString("connectionLost");

        if (e.getMessage() != null)
            errorMessage = e.getMessage();
        main.java.com.valhalla.Logger.debug(errorMessage);
    ...
    public void connectionClosed() {
        ...
        if (BuddyList.getInstance().getSignoff()) {
            ...
            if (Settings.getInstance().getBoolean("reconnectOnDisconnect")) {
                ...
                {
                    main.java.com.valhalla.Logger.debug( "Connector thread is already running." );
                    return;
                }
