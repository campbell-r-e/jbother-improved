...
import main.java.com.valhalla.jbother.plugins.events.InitEvent;
...
import main.java.com.valhalla.pluginmanager.PluginLoader;
...
public class JBotherLoader {
     ...
     * @see main.java.com.valhalla.settings.Arguments
     */
            ...
            public void eventDispatched(AWTEvent evt) {
                if (evt instanceof KeyEvent) {
                    ...
                    if (e.getModifiers() == KeyEvent.CTRL_MASK
                        ...
                        main.java.com.valhalla.Logger.getDebugWindow().setVisible(true);
    ...
    protected void doLaunch() {
        ...
        main.java.com.valhalla.Logger.setLogFile(JBother.settingsDir + File.separatorChar
                + "jbother.log");
