...
import main.java.com.valhalla.gui.Standard;
import main.java.com.valhalla.jbother.*;
import main.java.com.valhalla.jbother.jabber.*;
import main.java.com.valhalla.jbother.jabber.smack.*;
import main.java.com.valhalla.jbother.jabber.smack.provider.*;
import main.java.com.valhalla.jbother.preferences.*;
import main.java.com.valhalla.misc.GnuPG;
import main.java.com.valhalla.misc.SimpleXOR;
import main.java.com.valhalla.settings.Settings;
...
public class ConnectorThread implements Runnable {
    ...
    private main.java.com.valhalla.jbother.jabber.smack.ConnectionListener conListener = new main.java.com.valhalla.jbother.jabber.smack.ConnectionListener();

    private main.java.com.valhalla.jbother.jabber.smack.RosterListener
     rosterListener =
      new main.java.com.valhalla.jbother.jabber.smack.RosterListener();
    ...
    private ConnectorThread() {
        ...
        ProviderManager.addIQProvider("query", "jabber:iq:search",
            new main.java.com.valhalla.jbother.jabber.smack.provider.SearchProvider());
     ...
     */
    public main.java.com.valhalla.jbother.jabber.smack.ConnectionListener getConnectionListener() {
        return conListener;
    }
    ...
    public void run() {
        errorMessage = null;
        resetCredentials();
        main.java.com.valhalla.Logger.debug("Connector thread starting...");
        ...
        try {
            ...
            if (main.java.com.valhalla.settings.Arguments.getInstance().getProperty("smackdebug") != null) {
            }else {
        ...
        if (errorMessage == null && connection != null) {
            ...
            filter = new PacketTypeFilter(main.java.com.valhalla.jbother.jabber.smack.LastActivity.class);
        ...
        if (errorMessage != null || connection == null) {
            ...
            if (persistent) {
                try {
                    ...
                    main.java.com.valhalla.Logger.logException(ex);
                }
                main.java.com.valhalla.Logger.debug("Connection error was: "
                        + errorMessage);
                errorMessage = null;
                ...
                main.java.com.valhalla.Logger.debug( "Retrying, attempt #" + connectCount );
                connectCount++;
        ...
        SwingUtilities.invokeLater( new Runnable() {
                public void run()
                {
                    ...
                    main.java.com.valhalla.Logger.debug("Connected");
