...
import main.java.com.valhalla.jbother.plugins.events.ExitingEvent;
...
public class TabFrame extends JFrame {
    ...
    public TabFrame() {
        ...
        main.java.com.valhalla.Logger.debug("TabFrame is being created");
    ...
    private void setTabPane(TabbedPanel pane) {
        ...
        this.tabPane = pane;
        main.java.com.valhalla.Logger.debug("Setting tab pane");
    ...
    public void saveStates() {
        if (isVisible()) {
            ...
            main.java.com.valhalla.Logger.debug("TabFrame is not visible");
        }
    ...
    public void switchTab(TabbedPanel tabPane) {
        main.java.com.valhalla.Logger.debug("Switching the tab");
    ...
    private void setPreferredLocation() {
        ...
        try {
            ...
            main.java.com.valhalla.Logger.logException(e);
        }
    ...
    public void leaveAll() {
        main.java.com.valhalla.Logger.debug("There are " + tabPane.getTabCount()
                + " rooms");
